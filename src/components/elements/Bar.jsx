...
export default function Bar({ percent, color = 'accent', freestyle, overflowEffect = false, height = 'h-2' }) {
    ...
    return (
        <div className={`bar ${safePercent > 100 && overflowEffect ? 'shadow-glow-intense' : ''} ${height}`}>
