...
- [ ] time tracking ( MVP) 
	...
	- [ ] it should be possible to switch tasks, even when they are not finished, when the user starts on another card, the old timer should stop
- [ ] DND
